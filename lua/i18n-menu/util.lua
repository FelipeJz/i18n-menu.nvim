...
function M.get_messages_dir()
	...
	local messages_dir = config and config.messages_dir and project_root .. config.messages_dir
		or project_root .. "/messages"
...
local function enter_translation(choice, translation_key, messages_dir)
	...
	local new_translation = vim.fn.input(
		"Enter translation for '" .. translation_key .. "' in " .. selected_language .. ": ",
		current_translation
	)
